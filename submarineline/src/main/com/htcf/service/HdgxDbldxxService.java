...
public interface HdgxDbldxxService {
	 ...
	 */
	List<HdgxDbldxxEntity> fetchDbldxx(HdgxDbldxxEntity dbldxxEntity, PageBean pageBean);
	...
	/**
		 ...
		 */
	List<HdgxDbldxxEntity> fetchDbldByTime(String startTime, String endTime);
}
