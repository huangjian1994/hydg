...
$.dialog = {
    ...
    alert: function(set) {
        ...
        $("body").append('<div class="dialog" style="width:' + d.width + 'px; height:' + d.height + 'px; position:fixed; top:' + getTop(d.height) + '%; left:' + getLeft(d.width) + '%; z-index:10002;"></div>');
...
/*添加遮罩*/
function addMask() {
    $("body").append('<div class="mask" style="width:100%; height:100%; position:fixed; top:0; left:0; z-index:10001;" onclick="$.dialog.close();"></div>');
}
/*计算定位距左*/
