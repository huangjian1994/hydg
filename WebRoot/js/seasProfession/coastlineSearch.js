...
require([
	...
	"esri/InfoTemplate","esri/symbols/SimpleLineSymbol","esri/symbols/SimpleMarkerSymbol",
...
//		    		console.log(result);
			...
			var template = new InfoTemplate("名称：${name}",
					"上传人：${person}<br/>修订时间：${time}<br/>备注:${beizhu}");
