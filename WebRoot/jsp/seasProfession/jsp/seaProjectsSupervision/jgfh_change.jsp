		...
		<div class="formbody">
			...
			<table width="100%" align="center" style="text-align:left;" class="tableXQ">
				<tr>
					...
					<td style="background-color:#e8edef;">用海界址：</td>
				...
				<tr>
					...
					<td><input name="" type="text" class="scinput" value="外来施工" style="width:180px;height:20px;" /></td>
				</tr>
				<tr>
					<td style="background-color:#e8edef;">施工进展情况：</td>
					<td><input name="" type="text" class="scinput" value="施工" style="width:180px;height:20px;" />
					</td>
					<td style="background-color:#e8edef;">实际用途：</td>
					<td><input name="" type="text" class="scinput" value="哈哈" style="width:180px;height:20px;" />
					</td>
				</tr>
				<tr>
					<td style="background-color:#e8edef;">岸滩演变情况：</td>
					<td><input name="" type="text" class="scinput" value="无" style="width:180px;height:20px;" /></td>
					<td style="background-color:#e8edef;">复核是否一致：</td>
