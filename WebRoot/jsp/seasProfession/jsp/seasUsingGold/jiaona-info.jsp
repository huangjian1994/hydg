				...
				<div class="formbody">
					<table width="100%" align="center" style="text-align:left;" class="tableXQ">
						...
						<tr>
							...
							<td><input name="" type="text" class="scinput" value="广州市迪阳有限公司开采续用海域" style="width:180px;height:20px;" /></td>
						...
						<tr>
							...
							<td><input name="" type="text" class="scinput" value="广州市迪阳有限公司" style="width:180px;height:20px;" /></td>
						...
						<tr>
							...
							<td>
								<input name="" type="text" class="scinput" value="3" style="width:180px;height:20px;" />
							</td>
						</tr>

						<tr style="margin-top: 10px;">
							<td style="background-color:#e8edef;">缴纳日期</td>
							<td><input name="" type="datetime" class="scinput" value="2013-11-22" style="width:180px;height:20px;" /></td>
						...
						<tr>
							...
							<td><input name="" type="text" class="scinput" value="2013-10-11" style="width:180px;height:20px;" /></td>
						</tr>
					</table>
					<table width="100%" align="center" style="text-align:center;margin-top: 20px;" class="tableXQ table1">
						...
						<tr>
							<td><input name="" type="text" class="scinput" value="海砂等矿产开采" style="width:95%" /></td>
							<td><input name="" type="text" class="scinput" value="78.85" style="width:95%" /></td>
							<td><input name="" type="text" class="scinput" value="1023975" style="width:95%" /></td>
							<td><input name="" type="text" class="scinput" value="2389275" style="width:95%" /></td>
							<td><input name="" type="text" class="scinput" value="1023975" style="width:95%" /></td>
							<td><input name="" type="text" class="scinput" value="2389075" style="width:95%" /></td>
							<td><input name="" type="text" class="scinput" value="3413250" style="width:95%" /></td>
							<td><input name="" type="text" class="scinput" value="0" style="width:95%" /></td>
							<td><input name="" type="text" class="scinput" value="0" style="width:95%" /></td>
							<td><input name="" type="text" class="scinput" value="0	" style="width:95%" /></td>
						</tr>
					</table>
