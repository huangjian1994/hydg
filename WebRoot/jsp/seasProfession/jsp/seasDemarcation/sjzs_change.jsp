		...
		<div class="formbody">
			...
			<table width="100%" align="center" style="text-align:left;" class="tableXQ">
				<tr>
					...
					<td style="background-color:#e8edef;">矢量数据：</td>
					<td><input name="" type="text" class="scinput" value="东经121.67度北纬39.88度" style="width:180px;height:20px;" /></td>
				</tr>
				<tr>
					<td style="background-color:#e8edef;">数据类型 ：</td>
					<td>
				...
				<tr>
					...
					<td colspan="3"><input name="" type="text" class="scinput" value="2016-9-24" style="width:180px;height:20px;" />
					</td>
				</tr>
				<tr>
					<td colspan="4" style="text-align:center;">
						<input type="button" class="scbtn1" name="btn" onclick="window.location='sjzs.jsp'" value="保存" />
						<input name="fh" type="button" value="返回" class="scbtn1" onclick="window.location='sjzs.jsp'" />
					</td>
				</tr>
			</table>
		</div>
