		...
		<div class="formbody">
			...
			<table width="100%" align="center" style="text-align:left;" class="tableXQ">
				<tr>
					...
					<td colspan="3">${hysyywHygnqhHykjHjfa.wjm }</td>
				</tr>
				<tr>
					<td style="background-color:#f5f8fa;">海域界线材料文件类型：</td>
					<td colspan="3">${hysyywHygnqhHykjHjfa.wjlx }</td>
				</tr>
				<tr>
					...
					<!-- -->
					<c:if test="${hysyywHygnqhHykjHjfa.wjlx =='图件jpg' }">
					<img src="<%=basePath%>/files/hykj/hjfa/${hysyywHygnqhHykjHjfa.fj }" width="200" height="200"/>
					</c:if>
					<c:if test="${hysyywHygnqhHykjHjfa.wjlx !='图件jpg' }">
					<a href="###" onclick="downloadMediafj('${hysyywHygnqhHykjHjfa.fj }')" class="tablelink">
					<font color="blue">
					${hysyywHygnqhHykjHjfa.fj }</font>
					</a>
					</c:if>
				...
				<tr>
					...
					<td colspan="3">${hysyywHygnqhHykjHjfa.bz }</td>
				</tr>
				<tr>
					<td style="background-color:#f5f8fa;">新增用户姓名：</td>
					<td colspan="3">${hysyywHygnqhHykjHjfa.addusername }</td>
				</tr>
				<tr>
					<td width="20%" style="background-color:#f5f8fa;">新增时间：</td>
					<td width="30%">${hysyywHygnqhHykjHjfa.addtime }</td>
					<td width="20%" style="background-color:#f5f8fa;">最后修改时间：</td>
					<td width="30%">${hysyywHygnqhHykjHjfa.lastupdatetime }</td>
				</tr>
				<tr>
