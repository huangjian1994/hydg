...
<body style="background-color: white">
	...
	<div class="leftinfo1">
	<div class="listtitle3"><img src="${contextPath}/images/i02.png" width="25" height="25" />多媒体信息：音频/视频</div>
	
		<div id="content" style="margin-top: 10px;height:800px;" align="center">
		   	 <!-- 只支持MP4 webm ogg格式 -->
		   	 <c:if test="${hysyywHygnqhHykjDmtxx.type == 'video/mp4' || hysyywHygnqhHykjDmtxx.type == 'audio/ogg' }">
		   	 <video id="my_video_1" controls="controls" preload="auto" width="900px" height="600px" >
				<source src="/hydg/files/media/${hysyywHygnqhHykjDmtxx.fj}" type='video/mp4'/>
				<source src="/hydg/files/media/${hysyywHygnqhHykjDmtxx.fj}" type='video/webm'/>
				<source src="/hydg/files/media/${hysyywHygnqhHykjDmtxx.fj}" type='video/ogg'/>
				<!-- 
			...
			谷歌不支持，播放文件路径使用虚拟路径
			 ...
			 <c:if test="${hysyywHygnqhHykjDmtxx.type != 'video/mp4' && hysyywHygnqhHykjDmtxx.type != 'audio/ogg' }">
				...
				<PARAM NAME="URL" VALUE="/hydg/files/media/${hysyywHygnqhHykjDmtxx.fj}">
