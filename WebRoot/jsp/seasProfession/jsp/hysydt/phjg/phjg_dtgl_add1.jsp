...
function updateJgxx(){
	...
	if(document.getElementById("yhxmmc").value ==""){
		...
		document.getElementById("hysyywHysydtYhxmphjgDt.yhxmmc").value=strarray[1];
	...
	document.myForm.action="<%=basePath%>/business/business_updateJgxx1.do";
			...
			<div id="usual1" class="usual">
				<div class="leftinfo1">
					<div class="itab">
						<ul>
							<li>
								<a href="###" onclick="goAdd1()" class="selected">基本信息
			...
			<table width="100%" align="center" style="text-align:left;" class="tablelist2">
				...
				<tr>
					...
					<td width="30%">
						...
						<input name="hysyywHysydtYhxmphjgDt.yhxmmc" id="hysyywHysydtYhxmphjgDt.yhxmmc" type="hidden" value="${hysyywHysydtYhxmphjgDt.yhxmmc }" />
					</td>
				...
				<tr>
					...
					<td colspan="3">
						<input name="hysyywHysydtYhxmphjgDt.rwmc" id="rwmc" type="text" class="scinput" value="${hysyywHysydtYhxmphjgDt.rwmc }" style="width:500px; " />
						<font color="red">*</font>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<textarea name="hysyywHysydtYhxmphjgDt.hcrymd" id="dcrymd" rows="2" cols="70">${hysyywHysydtYhxmphjgDt.hcrymd }</textarea>
						<font color="red">*</font>
					</td>
				</tr>
				<tr>
					...
					<td width="30%">
						<input name="hysyywHysydtYhxmphjgDt.hcdwmc" id="dcdwmc"  type="text" class="scinput" value="${hysyywHysydtYhxmphjgDt.hcdwmc }" style="width:180px; " />
						<font color="red">*</font>
					</td>
				</tr>
				...
				<tr id="jsjcTR1"><!-- 建设过程监管 -->
					...
					<td colspan="3">
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfydg" type="radio" value="是" <c:if test="${hysyywHysydtYhxmphjgDt.sfydg=='是'}">checked="checked"</c:if> />是
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfydg" type="radio" value="否" <c:if test="${hysyywHysydtYhxmphjgDt.sfydg=='否'}">checked="checked"</c:if> />否
				...
				<tr id="jsjcTR2" style="display:none;"><!-- 竣工用海复核 -->
					...
					<td colspan="3">
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfagdyxsg" type="radio" value="是" <c:if test="${hysyywHysydtYhxmphjgDt.sfagdyxsg=='是'}">checked="checked"</c:if>/>是
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfagdyxsg" type="radio" value="否" <c:if test="${hysyywHysydtYhxmphjgDt.sfagdyxsg=='否'}">checked="checked"</c:if> />否
					</td>
				</tr>
				<tr id="jsjcTR3"><!-- 建设过程监管、竣工用海复核 -->
					<td style="background-color:#f5f8fa;">是否超范围填海：</td>
					<td colspan="3">
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfcfwth" type="radio" value="是" <c:if test="${hysyywHysydtYhxmphjgDt.sfcfwth=='是'}">checked="checked"</c:if>/>是
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfcfwth" type="radio" value="否" <c:if test="${hysyywHysydtYhxmphjgDt.sfcfwth=='否'}">checked="checked"</c:if> />否
					</td>
				</tr>
				<tr id="jsjcTR4" ><!-- 建设过程监管、竣工用海复核 -->
					<td style="background-color:#f5f8fa;">用海界址是否改变：</td>
					<td>
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.yhjzsfgb" type="radio" value="是" <c:if test="${hysyywHysydtYhxmphjgDt.yhjzsfgb=='是'}">checked="checked"</c:if>/>是
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.yhjzsfgb" type="radio" value="否" <c:if test="${hysyywHysydtYhxmphjgDt.yhjzsfgb=='否'}">checked="checked"</c:if> />否
						<font color="red">*</font>
					</td>
					<td style="background-color:#f5f8fa;">用海面积是否改变：</td>
					<td>
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.yhmjsfgb" type="radio" value="是" <c:if test="${hysyywHysydtYhxmphjgDt.yhmjsfgb=='是'}">checked="checked"</c:if>/>是
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.yhmjsfgb" type="radio" value="否" <c:if test="${hysyywHysydtYhxmphjgDt.yhmjsfgb=='否'}">checked="checked"</c:if> />否
						<font color="red">*</font>
					</td>
				</tr>
				<tr id="jsjcTR5"><!-- 建设过程监管、竣工用海复核、核查监视监测信息 -->
					<td style="background-color:#f5f8fa;">用海面积：</td>
					<td colspan="3"><input name="hysyywHysydtYhxmphjgDt.yhmj" id="hysyywHysydtYhxmphjgDt.yhmj"  type="text" class="scinput" value="${hysyywHysydtYhxmphjgDt.yhmj }" style="width:180px; " />公顷<font color="red">*</font></td>
				</tr>
				<tr id="jsjcTR6"><!-- 建设过程监管 -->
					<td style="background-color:#f5f8fa;">施工方式：</td>
					<td colspan="3"><input name="hysyywHysydtYhxmphjgDt.sgfs" id="hysyywHysydtYhxmphjgDt.sgfs"  type="text" class="scinput" value="${hysyywHysydtYhxmphjgDt.sgfs }" style="width:180px; " /><font color="red">*</font></td>
				</tr>
				<tr id="jsjcTR7"><!-- 建设过程监管 -->
					<td style="background-color:#f5f8fa;">施工进展情况：</td>
					<td colspan="3">
					<textarea name="hysyywHysydtYhxmphjgDt.sgjzqk" id="hysyywHysydtYhxmphjgDt.sgjzqk" rows="4" cols="60">${hysyywHysydtYhxmphjgDt.sgjzqk }</textarea><font color="red">*</font>
					</td>
				</tr>
				<tr id="jsjcTR8"><!-- 建设过程监管、竣工用海复核 -->
					<td style="background-color:#f5f8fa;">实际用途是否改变：</td>
					<td colspan="3">
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sjytsfgb" type="radio" value="是" <c:if test="${hysyywHysydtYhxmphjgDt.sjytsfgb=='是'}">checked="checked"</c:if>/>是
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sjytsfgb" type="radio" value="否" <c:if test="${hysyywHysydtYhxmphjgDt.sjytsfgb=='否'}">checked="checked"</c:if> />否
						<font color="red">*</font>
					</td>
				</tr>
				...
				<tr id="jsjcTR11" style="display:none;"><!-- 日常监管 -->
					...
					<td colspan="3">
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfzyhy" type="radio" value="是" <c:if test="${hysyywHysydtYhxmphjgDt.sfzyhy=='是'}">checked="checked"</c:if>/>是
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfzyhy" type="radio" value="否" <c:if test="${hysyywHysydtYhxmphjgDt.sfzyhy=='否'}">checked="checked"</c:if> />否
						<font color="red">*</font>
					</td>
				</tr>
				...
				<tr id="jsjcTR13" style="display:none;"><!-- 日常监管 -->
					...
					<td colspan="3">
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfffwth" type="radio" value="是" <c:if test="${hysyywHysydtYhxmphjgDt.sfffwth=='是'}">checked="checked"</c:if>/>是
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfffwth" type="radio" value="否" <c:if test="${hysyywHysydtYhxmphjgDt.sfffwth=='否'}">checked="checked"</c:if> />否
						<font color="red">*</font>
					</td>
				</tr>
				...
				<tr id="jsjcTR15" style="display:none;"><!-- 日常监管 -->
					...
					<td colspan="3">
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfszgbhyyt" type="radio" value="是" <c:if test="${hysyywHysydtYhxmphjgDt.sfszgbhyyt=='是'}">checked="checked"</c:if> />是
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfszgbhyyt" type="radio" value="否" <c:if test="${hysyywHysydtYhxmphjgDt.sfszgbhyyt=='否'}">checked="checked"</c:if>/>否
						<font color="red">*</font>
					</td>
				</tr>
				...
				<tr id="jsjcTR17" style="display:none;"><!-- 核查监视监测信息 -->
					...
					<td>
						<input name="hysyywHysydtYhxmphjgDt.ydyqwz" id="ydyqwz"  type="text" class="scinput" value="${hysyywHysydtYhxmphjgDt.ydyqwz }" style="width:180px; " />
						<font color="red">*</font>
					</td>
					<td style="background-color:#f5f8fa;">用海方式：</td>
					<td>
						<input name="hysyywHysydtYhxmphjgDt.yhfs" id="yhfs"  type="text" class="scinput" value="${hysyywHysydtYhxmphjgDt.yhfs }" style="width:180px; " />
						<font color="red">*</font>
					</td>
				</tr>
				<tr id="jsjcTR18" style="display:none;"><!-- 核查监视监测信息 -->
					...
					<td colspan="3">
						<textarea name="hysyywHysydtYhxmphjgDt.sjyt" id="sjyt" rows="4" cols="60">${hysyywHysydtYhxmphjgDt.sjyt }</textarea>
						<font color="red">*</font>
					</td>
				</tr>
				<tr id="jsjcTR19" style="display:none;"><!-- 核查监视监测信息 -->
					...
					<td colspan="3">
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfwgyh" type="radio" value="是"  <c:if test="${hysyywHysydtYhxmphjgDt.sfwgyh=='是'}">checked="checked"</c:if>/>是
						<input style="border:0;" name="hysyywHysydtYhxmphjgDt.sfwgyh" type="radio" value="否" <c:if test="${hysyywHysydtYhxmphjgDt.sfwgyh=='否'}">checked="checked"</c:if>/>否
						<font color="red">*</font>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<textarea name="hysyywHysydtYhxmphjgDt.bz" id="hysyywHysydtYhxmphjgDt.bz" rows="4" cols="60">${hysyywHysydtYhxmphjgDt.bz }</textarea>
					</td>
				</tr>
				
				<tr>
					<td colspan="4" style="text-align:center;">
						<input type="button" class="scbtn1" name="btn" onclick="updateJgxx()" value="修改" />
