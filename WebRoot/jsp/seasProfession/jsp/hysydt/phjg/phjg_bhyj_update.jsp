...
function updateYjxx(){
	...
	document.myForm.action="<%=basePath%>/business/business_updateYjxx.do";
...
<form name="myForm" method="post" >
		...
		<div class="formbody">
			...
			<table width="100%" align="center" style="text-align:left;" class="tablelist2">
				<tr>
					...
					${hysyywHysydtYhxmphjgYj.xmmc }
					<input name="hysyywHysydtYhxmphjgYj.xmmc" id="hysyywHysydtYhxmphjgYj.xmmc" type="hidden" value="${hysyywHysydtYhxmphjgYj.xmmc }" />
					</td>
					<td width="50%">
					<div class="tools">
						<ul class="toolbar">
				...
				<tr>
					...
					<td colspan="3">
					<input name="hysyywHysydtYhxmphjgYj.yjjkqsrq" id="yjjkqsrq" type="text" class="scinput" value="${hysyywHysydtYhxmphjgYj.yjjkqsrq }" onclick="WdatePicker()" readonly="readonly" style="width:180px; " />
					<font color="red">*</font>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
					<input name="hysyywHysydtYhxmphjgYj.yjjkzzrq" id="yjjkzzrq" type="text" class="scinput" value="${hysyywHysydtYhxmphjgYj.yjjkzzrq }" onclick="WdatePicker()" readonly="readonly" style="width:180px; " />
					<font color="red">*</font>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="4" style="text-align:center;">
						<input type="button" class="scbtn1" name="btn" onclick="updateYjxx()" value="保存" />
						<input name="fh" type="button" value="返回" class="scbtn1" onclick="goBack()" />
		<input name="hysyywHysydtYhxmphjgYj.yhjzsfgb" id="hysyywHysydtYhxmphjgYj.yhjzsfgb" value="${hysyywHysydtYhxmphjgYj.yhjzsfgb }" type="hidden" />
		<input name="hysyywHysydtYhxmphjgYj.yhmjsfgb" id="hysyywHysydtYhxmphjgYj.yhmjsfgb" value="${hysyywHysydtYhxmphjgYj.yhmjsfgb }" type="hidden" />
		<input name="hysyywHysydtYhxmphjgYj.sjytsfgb" id="hysyywHysydtYhxmphjgYj.sjytsfgb" value="${hysyywHysydtYhxmphjgYj.sjytsfgb }" type="hidden" />
		<input name="hysyywHysydtYhxmphjgYj.sfzyhy" id="hysyywHysydtYhxmphjgYj.sfzyhy" value="${hysyywHysydtYhxmphjgYj.sfzyhy }" type="hidden" />
		<input name="hysyywHysydtYhxmphjgYj.sfffwth" id="hysyywHysydtYhxmphjgYj.sfffwth" value="${hysyywHysydtYhxmphjgYj.sfffwth }" type="hidden" />
		<input name="hysyywHysydtYhxmphjgYj.sfszgbhyyt" id="hysyywHysydtYhxmphjgYj.sfszgbhyyt" value="${hysyywHysydtYhxmphjgYj.sfszgbhyyt }" type="hidden" />
		
		<input name="hysyywHysydtYhxmphjgYj.id" id="hysyywHysydtYhxmphjgYj.id" type="hidden" value="${hysyywHysydtYhxmphjgYj.id }" />
		<input name="hysyywHysydtYhxmphjgYj.addtime" id="hysyywHysydtYhxmphjgYj.addtime" type="hidden" value="${hysyywHysydtYhxmphjgYj.addtime }" />
		<input name="hysyywHysydtYhxmphjgYj.lastupdatetime" id="hysyywHysydtYhxmphjgYj.lastupdatetime" type="hidden" value="${hysyywHysydtYhxmphjgYj.lastupdatetime }" />
		<input name="hysyywHysydtYhxmphjgYj.addusername" id="hysyywHysydtYhxmphjgYj.addusername" type="hidden" value="${hysyywHysydtYhxmphjgYj.addusername }" />
		<input name="hysyywHysydtYhxmphjgYj.adduserid" id="hysyywHysydtYhxmphjgYj.adduserid" type="hidden" value="${hysyywHysydtYhxmphjgYj.adduserid }" />
		<input name="hysyywHysydtYhxmphjgYj.xmid" id="hysyywHysydtYhxmphjgYj.xmid" type="hidden" value="${hysyywHysydtYhxmphjgYj.xmid }" />
		...
		<script type="text/javascript">
			...
			if( document.getElementById("hysyywHysydtYhxmphjgYj.yhjzsfgb").value =="是"){
				document.getElementById("yhjzsfgb").checked = true;
			}
			if( document.getElementById("hysyywHysydtYhxmphjgYj.yhmjsfgb").value =="是"){
				document.getElementById("yhmjsfgb").checked = true;
			}
			if( document.getElementById("hysyywHysydtYhxmphjgYj.sjytsfgb").value =="是"){
				document.getElementById("sjytsfgb").checked = true;
			}
			if( document.getElementById("hysyywHysydtYhxmphjgYj.sfzyhy").value =="是"){
				document.getElementById("sfzyhy").checked = true;
			}
			if( document.getElementById("hysyywHysydtYhxmphjgYj.sfffwth").value =="是"){
				document.getElementById("sfffwth").checked = true;
			}
			if( document.getElementById("hysyywHysydtYhxmphjgYj.sfszgbhyyt").value =="是"){
				document.getElementById("sfszgbhyyt").checked = true;
			}
