...
function addHysyj(){
	...
	document.myForm.action="<%=basePath%>/seaUseGold/seaUseGold_saveHysyj2.do";
...
function updateHysyj(){
	...
	document.myForm.action="<%=basePath%>/seaUseGold/seaUseGold_updateHysyj2.do";
	document.myForm.target="_self";
	document.myForm.submit();
}
//删除
function deleteHysyj(hysyjID){
	if(confirm("确定删除该记录吗？")){
		...
		document.myForm.action="<%=basePath%>/seaUseGold/seaUseGold_deleteHysyj2.do";
		document.myForm.target="_self";
		document.myForm.submit();
	}
}
