...
$(document).ready(function(){
	...
	getDictionary("使用金征收标准用海类别A","yhlxa","");
	getDictionary("使用金征收标准用海类别B","yhlxb","");
	//getDictionary("海域等别","hydb","");
	getDictionary("征收方式","zsfs","");
...
function saveZsbz(){
	...
	document.myForm.action="<%=basePath%>/seaUseGold/seaUseGold_addZsbz.do";
		...
		<input name="zsbh" id="zsbh" type="hidden" value="" />
			...
			<table width="100%" align="center" style="text-align:left;" class="tablelist2" >
				...
				<tr>
					...
					<td>
						<input name="hysyywHysydtYhxmHysyjZsbz.hydb1" id="hydb1" type="text" value="" class="NumDecText" style="width:180px;" />
						万元/公顷
					</td>
				</tr>
				<tr>
					...
					<td>
						<input name="hysyywHysydtYhxmHysyjZsbz.hydb2" id="hydb2" type="text" value="" class="NumDecText" style="width:180px;" />
						万元/公顷
					</td>
				</tr>
				<tr>
					...
					<td>
						<input name="hysyywHysydtYhxmHysyjZsbz.hydb3" id="hydb3" type="text" value="" class="NumDecText" style="width:180px;" />
						万元/公顷
					</td>
				</tr>
				<tr>
					...
					<td>
						<input name="hysyywHysydtYhxmHysyjZsbz.hydb4" id="hydb4" type="text" value="" class="NumDecText" style="width:180px;" />
						万元/公顷
					</td>
				</tr>
				<tr>
					...
					<td>
						<input name="hysyywHysydtYhxmHysyjZsbz.hydb5" id="hydb5" type="text" value="" class="NumDecText" style="width:180px;" />
						万元/公顷
					</td>
				</tr>
				<tr>
					...
					<td>
						<input name="hysyywHysydtYhxmHysyjZsbz.hydb6" id="hydb6" type="text" value="" class="NumDecText" style="width:180px;" />
						万元/公顷
					</td>
				</tr>
				<tr>
					...
					<td>
						<input name="hysyywHysydtYhxmHysyjZsbz.yz" id="yz" type="text" value=""  style="width:300px;" />
				...
				<tr>
					...
					<td>
						<select name="hysyywHysydtYhxmHysyjZsbz.zsfs" id="zsfs" style="width:180px;">
							<option value="">-请选择-</option>
						</select><font color="red">*</font>
					</td>
				</tr>
