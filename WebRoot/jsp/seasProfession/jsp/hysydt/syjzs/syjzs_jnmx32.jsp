...
function addHysyj(){
	...
	document.myForm.action="<%=basePath%>/seaUseGold/seaUseGold_saveHysyj32.do";
...
function updateHysyj(){
	...
	document.myForm.action="<%=basePath%>/seaUseGold/seaUseGold_updateHysyj32.do";
	document.myForm.target="_self";
	document.myForm.submit();
}
//删除
function deleteHysyj(hysyjID){
	if(confirm("确定删除该记录吗？")){
		...
		document.myForm.action="<%=basePath%>/seaUseGold/seaUseGold_deleteHysyj32.do";
		document.myForm.target="_self";
		document.myForm.submit();
	}
}
		...
		<div id="usual1" class="usual">
			<div class="leftinfo1">
				...
				t.YHLXA,t.YHLXB,t.SFWLSYH,t.YHSX
					...
					<tr><!-- XMMC,XMWZ,HYSYQR,QQFS,YHLXA,YHLXB,SFWLSYH,YHSX, -->
						<td style="background-color:#f5f8fa;">海域管理号：</td>
						<td colspan="3">无
						<input name="hysyywHysydtYhxmHysyj.hyglh" id="hysyywHysydtYhxmHysyj.hyglh" type="hidden" value="" />
						</td>
					</tr>
					<tr>
						<td width="20%" style="background-color:#f5f8fa;">项目名称：</td>
						<td width="30%">${r[0] }
						<input name="hysyywHysydtYhxmHysyj.xmmc" id="xmmc" type="hidden" value="${r[0] }" />
						</td>
						<td width="20%" style="background-color:#f5f8fa;">项目位置：</td>
						<td width="30%">${r[8] }
						<input name="hysyywHysydtYhxmHysyj.xmwz" id="xmwz" type="hidden" value="${r[1] }" />
						</td>
					</tr>
					<tr>
						<td style="background-color:#f5f8fa;">海域使用权人：</td>
						<td>${r[2] }
						<input name="hysyywHysydtYhxmHysyj.hysyqr" id="hysyqr" type="hidden" value="${r[2] }" />
						</td>
						<td style="background-color:#f5f8fa;">确权方式：</td>
						<td>${r[9] }
						<input name="hysyywHysydtYhxmHysyj.qqfs" id="qqfs" type="hidden" value="${r[3] }" />
						</td>
					</tr>
					<tr>
						<td style="background-color:#f5f8fa;">用海类型A：</td>
						<td>${r[10] }
						<input name="hysyywHysydtYhxmHysyj.yhlxa" id="yhlxa" type="hidden" value="${r[4] }" />
						</td>
						<td style="background-color:#f5f8fa;">用海类型B：</td>
						<td>${r[11] }
						<input name="hysyywHysydtYhxmHysyj.yhlxb" id="yhlxb" type="hidden" value="${r[5] }" />
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<font color="red">*</font>
							<!-- ${r[9] } -->
							<input name="sfwlsyhY" id="sfwlsyhY" type="hidden" value="${r[6] }" />
						</td>
						<td style="background-color:#f5f8fa;">用海时限（日）：</td>
						<td>
						<input name="hysyywHysydtYhxmHysyj.yhsx" id="yhsx" type="text" value="${r[7] }" />
						</td>
					</tr>
					</c:forEach>
				</table><br />
