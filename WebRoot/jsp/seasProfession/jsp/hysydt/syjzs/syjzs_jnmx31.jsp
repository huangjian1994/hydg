...
function addHysyj(){
	...
	document.myForm.action="<%=basePath%>/seaUseGold/seaUseGold_saveHysyj31.do";
...
function updateHysyj(){
	...
	document.myForm.action="<%=basePath%>/seaUseGold/seaUseGold_updateHysyj31.do";
	document.myForm.target="_self";
	document.myForm.submit();
}
//删除
function deleteHysyj(hysyjID){
	if(confirm("确定删除该记录吗？")){
		...
		document.myForm.action="<%=basePath%>/seaUseGold/seaUseGold_deleteHysyj31.do";
		document.myForm.target="_self";
		document.myForm.submit();
	}
}
