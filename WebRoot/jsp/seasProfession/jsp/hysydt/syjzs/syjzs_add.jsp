...
function addHysyj(){
	...
	document.myForm.action="<%=basePath%>/seaUseGold/seaUseGold_saveHysyjWrk.do";
...
function getUpdate(id,addtime,lastupdatetime,addusername,adduserid,xmid,zsid,
		...
		jmje_zygk,jmje_dfgk,jmje_xj,jnrq,xmlx,djr,djsj,sfwlsyh,
		yhsx,sm,syjdqrq,jnfs,
...
function updateHysyj(){
	...
	document.myForm.action="<%=basePath%>/seaUseGold/seaUseGold_updateHysyj.do";
	document.myForm.target="_self";
	document.myForm.submit();
}
//删除
function deleteHysyj(hysyjID){
	if(confirm("确定删除该记录吗？")){
		...
		document.myForm.action="<%=basePath%>/seaUseGold/seaUseGold_deleteHysyj.do";
		document.myForm.target="_self";
		document.myForm.submit();
	}
}
		...
		<div id="usual1" class="usual">
			<div class="leftinfo1">
				...
				t.YHLXA,t.YHLXB,t.SFWLSYH,t.YHSX
					...
					<tr>
						...
						<img src="${contextPath}/images/i02.png" width="20" height="20" />缴纳明细
						</th>
					</tr>
					<tr>
						<td style="background-color:#f5f8fa;">海域管理号：</td>
						<td colspan="3">
						<input name="hysyywHysydtYhxmHysyj.hyglh" id="hysyywHysydtYhxmHysyj.hyglh" type="text" value="" style="width:250px;"/>
						</td>
					</tr>
					<tr>
						<td width="18%" style="background-color:#f5f8fa;">项目名称：</td>
						<td width="32%">
						<input name="hysyywHysydtYhxmHysyj.xmmc" id="xmmc" type="text" value="" style="width:250px;"/>
						<font color="red">*</font>
						</td>
						<td width="20%" style="background-color:#f5f8fa;">项目位置：</td>
						<td width="30%">
							<select name="hysyywHysydtYhxmHysyj.xmwz" id="xmwz" style="width:180px;height:25px;">
					...
					<tr>
						...
						<td>
							<input name="hysyywHysydtYhxmHysyj.hysyqr" id="hysyqr" type="text" value="" style="width:250px;"/>
						<font color="red">*</font>
						</td>
						<td style="background-color:#f5f8fa;">确权方式：</td>
						<td>
							<select name="hysyywHysydtYhxmHysyj.qqfs" id="qqfs" style="width:180px;height:25px;">
								<option value="">-请选择-</option>
							</select><font color="red">*</font>
						</td>
					</tr>
					<tr>
						...
						<td>
							<select name="hysyywHysydtYhxmHysyj.yhlxa" id="yhlxa" style="width:180px;height:25px;">
								<option value="">-请选择-</option>
							</select><font color="red">*</font>
						</td>
						<td style="background-color:#f5f8fa;">用海类型B：</td>
						<td>
							<select name="hysyywHysydtYhxmHysyj.yhlxb" id="yhlxb" style="width:180px;height:25px;">
								<option value="">-请选择-</option>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="hysyywHysydtYhxmHysyj.yhsx" id="yhsx" type="text" value="" onclick="WdatePicker()" readonly="readonly" style="width:180px;"/>
						</td>
					</tr>
				</table><br />
			...
			<c:if test="${ not empty jnmxList }">
				<table class="tablelist"  width="100%">
					...
					<c:forEach items="${ jnmxList }" var="r" varStatus="j">
					<tr>
						<td>${ j.count }</td>
						<td>${r.jnrq }</td>
						<td>
						...
						<td>
							...
							'${r.zsje_xj }','${r.jmje_zygk }','${r.jmje_dfgk }','${r.jmje_xj }','${r.jnrq }','${r.xmlx }','${r.djr}','${r.djsj }','${r.sfwlsyh }',
							'${r.yhsx }','${r.sm }','${r.syjdqrq }','${r.jnfs }',
				...
				<table class="tablelist"  width="100%">
					<tr>
						...
						<img src="${contextPath}/images/ico02.png" width="20" height="20" />新增/修改
						</th>
					</tr>
					<tr>
					<td colspan="18">
					...
					<tr>
						...
						<td>
							<input disabled="disabled" name="hysyywHysydtYhxmHysyj.djsj" id="hysyywHysydtYhxmHysyj.djsj" readonly="readonly" type="text" value="" />
						</td>
					</tr>
					<tr>
