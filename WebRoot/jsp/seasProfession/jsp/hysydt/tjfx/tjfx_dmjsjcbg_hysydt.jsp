...
<form name="myForm" method="post" >
		...
		<div id="usual1" class="usual" >
			<div class="leftinfo1">
				<div class="itab" >
					<ul>
						<li><a href="###" onclick="gJhzfqk()" >地面监视监测计划执法情况</a></li>
						<li><a href="###" onclick="goHysydt()" class="selected">海域使用新增或变更动态</a></li>
						<!-- 
				...
				<table width="100%" align="center" style="text-align:center;">
					...
					<tr>
						...
						<td width="80%" style="text-align:left;">&nbsp;&nbsp;&nbsp;
							<input name="tjfxForm.tjfs" id="tjfs1" type="radio" value="按海域使用状态" checked="checked" style="border:0;"/>按海域使用状态&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
					 -->
					<tr>
		...
		<script type="text/javascript">
			...
			var tjys="海域项目数";
			var tjfs="";
			//tjys='海域使用新增或变更动态'; 按海域使用状态
			//var titlemc=tjfs+"统计"+tjys;
			var titlemc="按海域使用状态统计";
