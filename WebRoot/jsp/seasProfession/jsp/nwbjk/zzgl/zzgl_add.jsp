...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function saveYhxm(){
		...
		document.myForm.action="<%=basePath%>/qualification/qualification_addQualification.do";
		document.myForm.target="_self";
		document.myForm.submit();
	}
    </script>
				...
				<div class="listtitle"><img src="${contextPath}/images/ico02.png" width="20" height="20" />新增</div>
					<table style="width:98%;" class="tablelist2" align="center">
							...
							<tr>
								...
								<td colspan="3">
									<input name="hysyywNwbjkZzgl.shxydm" id="hysyywNwbjkZzgl.shxydm" type="text" value="" style="width:400px;" />
								</td>
							</tr>
							<tr id="zzTr2">
								<td  style="background-color:#f5f8fa;">证书编号：</td>
								<td>
									<input name="hysyywNwbjkZzgl.zsbh" id="zsbh" type="text" value="" style="width:200px;" />
									<font color="red">*</font>
								</td>
								<td  style="background-color:#f5f8fa;">单位名称：</td>
								<td>
									<input name="hysyywNwbjkZzgl.dwmc" id="dwmc" type="text" value="" style="width:200px;" />
									<font color="red">*</font>
								</td>
							</tr>
							<tr id="zzTr3">
								...
								<td>
									<input name="hysyywNwbjkZzgl.fddbr" id="fddbr" type="text" value="" style="width:200px;" />
									<font color="red">*</font>
								</td>
							...
							<tr id="zzTr4">
								...
								<td colspan="3">
									<textarea name="hysyywNwbjkZzgl.ywfw" id="ywfw" rows="3" cols="80" ></textarea>
									<font color="red">*</font>
								</td>
							</tr>
							<tr id="zzTr5">
								...
								<td colspan="3">
									<input name="hysyywNwbjkZzgl.yxqz" id="yxqz" type="text" value="" style="width:200px;" onclick="WdatePicker()" readonly="readonly" />
									<font color="red">*</font>
								</td>
							</tr>
							<tr id="zzTr6">
								...
								<td>
									<input name="hysyywNwbjkZzgl.fzjg" id="fzjg" type="text" value="" style="width:200px;" />
									<font color="red">*</font>
								</td>
								<td  style="background-color:#f5f8fa;">发证日期：</td>
								<td>
									<input name="hysyywNwbjkZzgl.fzrq" id="fzrq" onclick="WdatePicker()" readonly="readonly" type="text" value="" style="width:200px;" />
									<font color="red">*</font>
								</td>
							</tr>
							<tr id="zzTr7">
								...
								<td colspan="3">
									<input name="hysyywNwbjkZzgl.lxdz" id="lxdz" type="text" value="" style="width:500px;" />
								</td>
							</tr>
							<tr id="zzTr8">
								<td  style="background-color:#f5f8fa;">联系部门：</td>
								<td>
									<input name="hysyywNwbjkZzgl.lxbm" id="lxbm" type="text" value="" style="width:200px;" />
								</td>
								<td style="background-color:#f5f8fa;">联系人：</td>
								<td>
								<input name="hysyywNwbjkZzgl.lxr" id="lxr" type="text" value="" style="width:200px;" />
								</td>
							</tr>
							<tr id="zzTr9">
								<td  style="background-color:#f5f8fa;">电话：</td>
								<td>
									<input name="hysyywNwbjkZzgl.dh" id="dh" type="text" value="" style="width:200px;" />
								</td>
								<td  style="background-color:#f5f8fa;">E-mail：</td>
								<td>
								<input name="hysyywNwbjkZzgl.e_mail" id="e_mail" type="text" value="" style="width:200px;" />
								</td>
							</tr>
							<!-- 测绘资质证书 -->
							<tr id="zzTr10" style="display:none;">
								...
								<td colspan="3">
									<input name="hysyywNwbjkZzgl.zcdz" id="zcdz" type="text" value="" style="width:500px;" />
									<font color="red">*</font>
								</td>
							</tr>
							<tr id="zzTr11" style="display:none;">
								...
								<td colspan="3">
									<textarea name="hysyywNwbjkZzgl.zyfw" id="zyfw" rows="3" cols="80" ></textarea>
									<font color="red">*</font>
								</td>
							</tr>
							<tr id="zzTr12" style="display:none;">
								...
								<td colspan="3">
									<input name="hysyywNwbjkZzgl.chzlfcfzr" id="chzlfcfzr" type="text" value="" />
									<font color="red">*</font>
								</td>
							</tr>
							...
							<tr id="zzTr15" style="display:none;">
								...
								<td>
									<input name="hysyywNwbjkZzgl.chfzr" id="chfzr" type="text"  value="" style="width:200px;" />
									<font color="red">*</font>
								</td>
								<td  style="background-color:#f5f8fa;">测绘单位：</td>
								<td>
									<input name="hysyywNwbjkZzgl.chdw" id="chdw" type="text" value="" style="width:200px;" />
									<font color="red">*</font>
								</td>
							</tr>
							<tr id="zzTr16" style="display:none;">
								...
								<td>
									<input name="hysyywNwbjkZzgl.chrq" id="chrq" type="text" onclick="WdatePicker()" readonly="readonly" value="" style="width:200px;" />
									<font color="red">*</font>
								</td>
								<td  style="background-color:#f5f8fa;">测绘点数：</td>
								<td>
									<input name="hysyywNwbjkZzgl.chds" id="chds" type="text" value="" class="NumText" style="width:200px;" />
									<font color="red">*</font>
								</td>
							</tr>
							<tr id="zzTr17" style="display:none;">
								...
								<td>
									<input name="hysyywNwbjkZzgl.glblc" id="glblc" type="text" value="" style="width:200px;" />
									<font color="red">*</font>
								</td>
							</tr>
							...
							<tr id="zzTr19" style="display:none;">
								...
								<td><input name="hysyywNwbjkZzgl.lzbgmc" id="lzbgmc" type="text" value="" style="width:200px;" />
									<font color="red">*</font>
								</td>
								<td  style="background-color:#f5f8fa;">论证单位：</td>
								<td><input name="hysyywNwbjkZzgl.lzdw" id="lzdw" type="text" value="" style="width:200px;" />
									<font color="red">*</font>
								</td>
							</tr>
							<tr id="zzTr20" style="display:none;">
								...
								<td><input name="hysyywNwbjkZzgl.xmfzr" id="xmfzr" type="text" value="" style="width:200px;" />
									<font color="red">*</font>
								</td>
							</tr>
							<tr id="zzTr21" style="display:none;">
								<td  style="background-color:#f5f8fa;">组织评审部门：</td>
								<td><input name="hysyywNwbjkZzgl.zzpsbm" id="zzpsbm" type="text" value="" style="width:200px;" /><font color="red">*</font></td>
								<td  style="background-color:#f5f8fa;">评审专家组组长：</td>
								<td><input name="hysyywNwbjkZzgl.pszjzzz" id="pszjzzz" type="text" value="" style="width:200px;" /><font color="red">*</font></td>
							</tr>
							<tr id="zzTr22" style="display:none;">
								<td  style="background-color:#f5f8fa;">评审日期：</td>
								<td><input name="hysyywNwbjkZzgl.psrq" id="psrq" type="text" value="" onclick="WdatePicker()" readonly="readonly" style="width:200px;" /><font color="red">*</font></td>
								<td  style="background-color:#f5f8fa;">质量评估分：</td>
								<td><input name="hysyywNwbjkZzgl.zlpgf" id="zlpgf" type="text" class="NumText" value="" style="width:200px;" /><font color="red">*</font></td>
							</tr>
