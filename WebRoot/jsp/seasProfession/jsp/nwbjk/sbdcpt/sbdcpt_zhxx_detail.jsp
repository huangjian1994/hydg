	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
					<table style="width:98%;" class="tablelist2" align="center">
							...
							<tr>
								<td  style="background-color:#f5f8fa;color: blue;">用海项目名称：</td>
								<td colspan="3" style="color: blue;">${hysyywHysydtYhxm.yhxmmc }</td>
							</tr>
							<!-- 发改委项目代码 -->
							<tr>
							...
							<tr>
								<td  style="background-color:#f5f8fa;color: blue;">用海总面积：</td>
								<td style="color: blue;">${hysyywHysydtYhxm.yhzmj }公顷</td>
								<td  style="background-color:#f5f8fa;">投资额：</td>
								<td>${hysyywHysydtYhxm.tze } <font id="tzedwTD">${hysyywHysydtYhxm.tzedw }</font></td>
							</tr>
							<tr>
								<td  style="background-color:#f5f8fa;color: blue;">占用岸线：</td>
								<td style="color: blue;">${hysyywHysydtYhxm.zyax }米</td>
							...
							<tr>
								<td  style="background-color:#f5f8fa;color: blue;">海域等别：</td>
								<td id="hydbTD2" style="color: blue;">${hysyywHysydtYhxm.hydb }</td>
							...
							<tr>
								<td  style="background-color:#f5f8fa;color: blue;">发证机关：</td>
								<td style="color: blue;">${hysyywHysydtYhxm.fzjg }</td>
							...
							<tr>
								<td  style="background-color:#f5f8fa;color: blue;">海域使用权人：</td>
								<td style="color: blue;">${hysyywHysydtYhxm.hysyqr }</td>
			...
			<div id="tab9" class="tabson" >
				...
				<table class="tablelist2" width="100%">
					...
					<tr>
						<td style="background-color:#f5f8fa;color: blue;">用海项目名称：</td>
						<td style="color: blue;">${hysyywHysydtYhxmZsxx.yhxmmc}</td>
						<td style="background-color:#f5f8fa;color: blue;">海域使用权人：</td>
						<td style="color: blue;">${hysyywHysydtYhxmZsxx.hysyqr }</td>
					</tr>
					<tr>
						<td style="background-color:#f5f8fa;">用海面积：</td>
						<td>${hysyywHysydtYhxmZsxx.yhmj }公顷</td>
						<td style="background-color:#f5f8fa;color: blue;">海域等别：</td>
						<td id="hydbTD" style="color: blue;">${hysyywHysydtYhxmZsxx.hydb }</td>
					</tr>
					<tr>
						<td style="background-color:#f5f8fa;">法定代表人：</td>
					...
					<tr>
						<td style="background-color:#f5f8fa;color: blue;">发证机关：</td>
						<td style="color: blue;">${hysyywHysydtYhxmZsxx.fzjg }</td>
						<td style="background-color:#f5f8fa;">发证机关级别：</td>
					...
					<tr>
						...
						<td style="background-color:#f5f8fa;color: blue;">宗海面积：</td>
						<td style="color: blue;">${hysyywHysydtYhxmZsxx.zhmj }公顷</td>
					</tr>
					<tr>
						<td width="18%" style="background-color:#f5f8fa;color: blue;">用海类型A：</td>
						<td width="25%" id="yhlxaTD" style="color: blue;">${hysyywHysydtYhxmZsxx.yhlxa }</td>
						<td width="18%" style="background-color:#f5f8fa;color: blue;">用海类型B：</td>
						<td width="25%" id="yhlxbTD" style="color: blue;">${hysyywHysydtYhxmZsxx.yhlxb }</td>
					</tr>
					<tr>
						<td style="background-color:#f5f8fa;color: blue;">用海性质：</td>
						<td id="yhxzTD" style="color: blue;">${hysyywHysydtYhxmZsxx.yhxz }</td>
						<td style="background-color:#f5f8fa;">确权方式：</td>
						<td id="qqfsTD">${hysyywHysydtYhxmZsxx.qqfs }</td>
					</tr>
					<tr>
						<td style="background-color:#f5f8fa;color: blue;">海域使用金征收标准依据：</td>
						<td style="color: blue;">${hysyywHysydtYhxmZsxx.syjzsbzyj }</td>
						<td style="background-color:#f5f8fa;">用海设施和构筑物：</td>
						<td>${hysyywHysydtYhxmZsxx.yhssgzw }</td>
					</tr>
					<tr>
						<td style="background-color:#f5f8fa;color: blue;">海域使用金总额：</td>
						<td style="color: blue;">${hysyywHysydtYhxmZsxx.syjze }元</td>
						<td style="background-color:#f5f8fa;color: blue;">海域使用金缴纳方式：</td>
						<td id="syjjnfsTD" style="color: blue;">${hysyywHysydtYhxmZsxx.syjjnfs }</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="background-color:#f5f8fa;color: blue;">海域使用金征收标准：</td>
						<td colspan="3" style="color: blue;">${hysyywHysydtYhxmZsxx.syjzsbz }</td>
					</tr>
					
					<tr>
						<td style="background-color:#f5f8fa;color: blue;">用海位置文字说明：</td>
						<td colspan="3" style="color: blue;">${hysyywHysydtYhxmZsxx.yhwzwzsm }</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="background-color:#f5f8fa;color: blue;">审批表号或批准合同号：</td>
						<td style="color: blue;">${hysyywHysydtYhxmZsxx.spbh }</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="background-color:#f5f8fa;color: blue;">海域管理号：</td>
						<td style="color: blue;">${hysyywHysydtYhxmZsxx.hyglh }</td>
						<td style="background-color:#f5f8fa;color: blue;">发证日期：</td>
						<td style="color: blue;">${hysyywHysydtYhxmZsxx.fzrq }</td>
					</tr>
					<tr>
						<th colspan="4">备注</th>
					</tr>
			...
			<div id="tab4" class="tabson">
				...
				<table class="tablelist" width="95%">
					<tr>
						<th width="5%">序号</th>
						<th width="10%">标识</th>
						<th width="10%" style="color: blue;">用海方式</th>
						<th width="10%" style="color: blue;">面积</th>
						<th width="20%" style="color: blue;">具体用途</th>
						<!--  
						<th>操作</th><td></td>
						-->
					</tr>
					...
					<tr>
						<td>${ j.count }</td>
						<td>${r.bs }</td>
						<td style="color: blue;">${r.yhfsmc }</td>
						<td style="color: blue;">${r.mj }公顷<!-- 公顷 --></td>
						<td style="color: blue;">${r.jtyt }</td>
				...
				<div class="jzdzb" style="height: auto;float:right;width:50%;margin-top: 10px;">
					...
					<table width="100%" class="tablelist" style="text-align:center;">
						<tr>
							...
							<th style="color: blue;">北纬</th>
							<th style="color: blue;">东经</th>
						</tr>
						<c:forEach items="${ yhxmyhfsjzdList }" var="r" varStatus="j">
						<tr>
							<td width="20%" style="color: blue;">${r.xh }</td>
							<td width="30%" style="color: blue;">${r.wd }</td>
							<td width="30%" style="color: blue;">${r.jd }</td>
						</tr>
						</c:forEach>
					</table>
					<!-- 
			...
			<table width="100%" align="center" class="tablelist2" style="text-align:left;">
				...
				<table class="tablelist"  width="100%">
					...
					<tr>
						...
						<td style="color: blue;">${r.zsje_xj }</td>
						<td>${r.zsje_zygk }</td>
						<td>${r.zsje_dfgk }</td>
						<td>${r.zsje_s }</td>
						<td>${r.zsje_shi }</td>
				...
				<table class="tablelist" id="hysyjDetailTable" width="100%" style="display:none;">
					...
					<tr>
						<td width="20%" style="background-color:#f5f8fa;color: blue;">缴纳日期：</td>
						<td width="30%" style="background-color:#ffffff;color: blue;">
					...
					<tr>
						...
						<th width="5%" style="color: blue;">总额</th>
						<th width="5%">中央</th>
						<th width="5%">地方</th>
						<th width="5%">省</th>
						<th width="5%">市</th>
					...
					<tr>
						...
						<td style="color: blue;"><span id="hysyywHysydtYhxmHysyj.zsje_xj"></span></td>
		...
		<div id="tab6" class="tabson">
			...
			<table width="100%" class="tablelist" style="text-align:center;">
				<tr>
					<th width="5%">序号</th>
					<th width="30%" style="color: blue;">用海位置图</th>
					<th width="30%" style="color: blue;">界址图</th>
					<th width="15%">新增人</th>
					<th width="15%">新增时间</th>
				</tr>
