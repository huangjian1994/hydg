...
function getDictionaryFy(keyZ,tableTdID,historyZ){
	...
	function detaileXmxxZsxx(zsID){
		...
		document.myForm.action="<%=basePath%>/sbdcpt/sbdcpt_fetchZhxxDetail2.do";
		...
		<div id="usual1" class="usual">
				...
				<div id="tab1" class="tabson">
					<table style="width:98%;" class="tablelist2" align="center">
							...
							<tr>
								...
								<td id="hydbTD" style="color: blue;">${hysyywHysydtYhxm.hydb }</td>
			...
			<div id="tab3" class="tabson">
				<table class="tablelist" style="width:98%;border: solid 1px #c7c7c7;" align="center">
					...
					<tr style="border: solid 1px #c7c7c7;" >
						<th width="5%">序号</th>
						<th width="10%" style="color: blue;">海域管理号</th>
						<th width="15%" style="color: blue;">用海项目名称</th>
						<th width="20%" style="color: blue;">海域使用权人</th>
						<th width="25%" style="color: blue;">用海类型</th>
						<!-- 
						<th width="15%">用海方式</th><td>（${r.zhmj }公顷）</td>
						 -->
						<th width="6%" style="color: blue;">用海性质</th>
						<th width="6%">操作</th>
					</tr>
					</thead>
					...
					<tr>
						<td>${ j.count }</td>
						<td style="color: blue;">${r[2] }</td>
						<td style="color: blue;">${r[3] }</td>
						<td style="color: blue;">${r[4] }</td>
						<td style="color: blue;">${r[6] }
							<c:if test="${ not empty r[8] }">、${r[8] }</c:if>
							（${r[9] }公顷）
						</td>
						<td style="color: blue;">${r[11] }</td>
