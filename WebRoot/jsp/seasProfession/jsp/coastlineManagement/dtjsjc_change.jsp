...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script>
			...
			$(function() {
				addTab('纠纷管理', '${contextPath}/jsp/seasProfession/jsp/coastlineManagement/jfgl_change.jsp');
			})
		</script>
		...
		<div class="formbody">
			...
			<table width="100%" align="center" style="text-align:left;" class="tableXQ">
				...
				<tr>
					...
					<td>
						<input name="choose2" type="radio" class="scinput" checked style="vertical-align: middle;" />是
				...
				<tr>
					...
					<td>
						<input name="choose3" type="radio" class="scinput" checked style="vertical-align: middle;" />是
					...
					<td>
						...
						<input name="choose4" type="radio" class="scinput" checked style="vertical-align: middle;" />否
					</td>
				</tr>
				<tr>
					...
					<td>
						<input name="choose6" type="radio" class="scinput" checked style="vertical-align: middle;" />是
				...
				<tr>
					...
					<td>
						...
						<input name="choose7" type="radio" class="scinput" checked style="vertical-align: middle;" />否
					</td>
				...
				<tr>
					<td colspan="4" style="text-align:center;">
						<input type="button" class="easyui-linkbutton scbtn1" onclick="addTab('纠纷管理','${contextPath}/jsp/seasProfession/jsp/coastlineManagement/jfgl_change.jsp')" value="纠纷管理">
						<input type="button" class="easyui-linkbutton scbtn1" onclick="addTab('违法情况','${contextPath}/jsp/seasProfession/jsp/coastlineManagement/wfqk_change.jsp')" value="违法情况">
