		...
		<div class="formbody">
			...
			<table width="100%" align="center" style="text-align:left;" class="tableXQ">
				...
				<tr>
					...
					<td>
						<input name="choose5" type="radio" class="scinput" checked disabled style="vertical-align: middle;" />是
						<input name="choose5" type="radio" class="scinput" disabled style="vertical-align: middle;" />否
					</td>
