...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="${contextPath}/css/seasProfession/dtxdgl.css" rel="stylesheet" type="text/css" />
		...
		<script type="text/javascript" src="${contextPath}/js/seasProfession/coastlineChange.js"></script>	
		<script type="text/javascript" src="${contextPath}/js/seasProfession/dtxdgl.js"></script>	
	...
	function upLoadData(){
		...
		document.myForm.action="<%=basePath%>/dgiff/dgiff_saveHaxdtxd.do";
	...
	function xzZbmb(){
		//alert("下载");
		document.myForm.action="<%=basePath%>/dgiff/dgiff_downLoadHaxdtxdJwd.do";
		document.myForm.target="_self";
		document.myForm.submit();
	}
    </script>
	...
	<body>
    	<form name="myForm" method="post" enctype="multipart/form-data">
    		...
    		<div id="map">	</div>    		
    		<button class="button button-raised button-glow button-rounded button-primary" style="width:160px;position:absolute;right:10px;top:50px;z-index:10000;" type="button" onclick="showUp();">新增</button>		
    		<div id="submit">
    			<ul>
    				...
    				<li style="padding: 10px;"><label for="name">修订名称：</label><input id="name" name="coastline.lineName" type="text" /><font color="red">*</font></li>
    					<li style="padding: 10px;"><label for="people">修订人：</label><input id="people" name="coastline.lineUpdatePerson" type="text" /><font color="red">*</font></li>
    					<li style="padding: 10px;"><label for="time">修订日期：</label><input id="time" name="coastline.lineUpdateTime" type="text" onclick="WdatePicker()" readonly="readonly"/><font color="red">*</font></li>
