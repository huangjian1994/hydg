...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		$(function() {
			...
			//addTab('巡查人员考核评价', '${contextPath}/patorl/patorl_fetchXckpRykpTj.do');
		})
	...
	<body style="background:#f0f9fd;">
		<div style="height: 100%;width: 187px">
			...
			<dl class="leftmenu">
			<s:iterator  value="#session.menusMap.get('xckpgl')" status="stu">
				<dd>
					<div class="title">
				...
				<dd>
					<div class="title">
						<span ><img src="${contextPath}/images/seasInspection/leftico01.png" /></span>巡查考评管理
					</div>
					<ul class="menuson">
						<li><cite></cite>
