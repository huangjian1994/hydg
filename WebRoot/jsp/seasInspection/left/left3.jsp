...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		$(function() {
			...
			//addTab('分类管理', '${contextPath}/jsp/seasInspection/jsp/inquireStatistics/cxtj_index.jsp');
		})
	...
	<body style="background:#f0f9fd;">
		<div style="height: 100%;width: 187px">
			...
			<dl class="leftmenu">
				<s:iterator  value="#session.menusMap.get('cxtj')" status="stu">
				<dd>
					<div class="title">
			...
			<!-- 
				<dd>
					...
					<ul class="menuson">
						...
						<li><cite></cite>
							<a class="easyui-linkbutton" href="#" onclick="addTab('综合查询','${contextPath}/jsp/seasInspection/jsp/inquireStatistics/cxtj_zhcx.jsp')">综合查询</a></li>
						<li><cite></cite>
