...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		$(function() {
			...
			//addTab('巡查问题上报', '${contextPath}/jsp/seasInspection/jsp/islandInspection/hyhdxc_index.jsp');
		})
		</script>
	...
	<body style="background:#f0f9fd;">
		<div style="height: 100%;width: 187px">
			...
			<dl class="leftmenu">
			<s:iterator  value="#session.menusMap.get('hyhdxcgl')" status="stu">
				<dd>
					<div class="title">
			...
			<!-- 
				<dd>
					...
					<ul class="menuson">
						...
						<li><cite></cite>
							<a class="easyui-linkbutton" href="#" onclick="addTab('巡查任务下派','${contextPath}/jsp/seasInspection/jsp/islandInspection/hyhdxc_rwxp.jsp')">巡查任务下派</a></li>
						<li><cite></cite>
