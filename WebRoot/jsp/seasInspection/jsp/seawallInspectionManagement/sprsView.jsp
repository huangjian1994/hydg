							...
							<tbody>
								<c:forEach items="${sprs}" var="spr" varStatus="i">
									<tr>
										...
										<td>
											<c:choose>
												<c:when test="${spr.nmState == 2 }">上报</c:when>
												<c:when test="${spr.nmState == 2 }">立案</c:when>
												<c:when test="${spr.nmState == 3 }">派遣</c:when>
												<c:when test="${spr.nmState == 4 }">处理</c:when>
												<c:when test="${spr.nmState == 5 }">确认</c:when>
											</c:choose>
										</td>
										<td>
