...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="formbody">
			<!--<div class="tools">
    	<ul class="toolbar">
        <li><a href="xcjhgl_add.html"><span><img src="${contextPath}/images/seasInspection/t01.png" /></span>新增</a></li>
        <li><a href="xcjhgl_update.html"><span><img src="${contextPath}/images/seasInspection/t02.png" /></span>修改</a></li>
        <li><span><img src="${contextPath}/images/seasInspection/t03.png" /></span>删除</li>
        </ul>
    </div>-->
			<div class="choice">请选择要采集的项目类型：
				<select name="ssbm" id="ssbm" onchange="jumpMenu(this)" style="width:180px;height:25px;">
					<option value="">-请选择-</option>
					<option value="zdwth.html" selected="selected">重点围填海在建项目地面监视监测</option>
					<option value="ydyq.html">疑点疑区监视监测</option>
				</select>
			</div>
