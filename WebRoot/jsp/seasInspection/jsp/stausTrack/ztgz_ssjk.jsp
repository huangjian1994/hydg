    ...
    <head>
        ...
        //点击居中方法
            ...
            function resert(){
                ...
                document.getElementById("nm_state").value ="";
    ...
    <body>   
        ...
        <div class="formbody" style="position:absolute;left:0;right:0;top:40px;bottom:0;overflow:hidden;width:100%;">
            <div class="leftinfo1">
                ...
                <s:form namespace="/status" action="status_loadSeawallPatorlThroughWs.do?lb=1" method="post">
                    <table width="100%" align="center" style="text-align:center;">
                        <tr>
                            ...
                            <td>处理状态：</td>
                            <td>
                                <s:select name="spfw.nm_state" id="nm_state" list="#{'':'-请选择-','1':'发现','2':'立案','3':'派遣','4':'处理','5':'结案'}" cssStyle="width:200px;height:25px;"></s:select>
                            </td>
                            <td>发现时间：</td>
                            <td style="text-align:center;">
                                <s:textfield onclick="WdatePicker()"  name="strBT" cssStyle="width:150px;"></s:textfield>
                                &nbsp;&nbsp;&nbsp;&nbsp;至&nbsp;&nbsp;&nbsp;&nbsp;
                                <s:textfield onclick="WdatePicker()"  name="strET" cssStyle="width:150px;"></s:textfield>
                            </td>
                        </tr>
                        <tr>
                            <td>问题类别：</td>
                            ...
                            <td>巡查人员：</td>
                            <td>
                                <s:textfield name="spfw.st_claimperson" id="claimperson" cssStyle="width:200px;" ></s:textfield>
                            </td>
            ...
            <div style="width:100%;position:absolute;left:18px;bottom:0;right:18px;top:150px;">                        
                            ...
                            <tbody>
                                <c:forEach items="${spfws}" var="sp" varStatus="i">
                                    <tr onclick="asdf(this)">
                                        <td>${i.index + 1 }</td>
                                         <td objectId="${sp.st_eventsn}" class="rwh">
                                            ${sp.st_esclass } - ${sp.st_ebclass}
                                        </td>
