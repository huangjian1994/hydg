							...
							<table width="100%" align="center" style="text-align:left;" class="tableXQ" cellSpacing='12' cellPadding='12'>
								<tr>
									...
									<td><input name="xcjhEntity.patrolname" id="patrolname" type="text"
												   class="scinput" value="${xcjhEntity.patrolname}" style="width:200px;" /><font color="red">*</font></td>
									<td style="background-color:#e8edef;">填表单位：</td>
									<td><input name="xcjhEntity.fillingdw" id="fillingdw" type="text"
											   class="scinput" value="${xcjhEntity.fillingdw}" style="width:200px;" /><font color="red">*</font></td>
								...
								<tr>
									...
									<td><input name="xcjhEntity.leadername" id="leadername" type="text"
											   class="scinput" value="${xcjhEntity.leadername}" style="width:200px;" /><font color="red">*</font></td>
									<td style="background-color:#e8edef;">巡查方式：</td>
									<td><input name="xcjhEntity.inspectionmode" id="inspectionmode" type="text"
											   class="scinput" value="${xcjhEntity.inspectionmode}" style="width:200px;" /><font color="red">*</font></td>
								</tr>

								<tr>
									<td style="background-color:#e8edef;">派出人员：</td>
									<td><input name="xcjhEntity.peoplename" id="peoplename"
											   type="text" class="scinput" value="${xcjhEntity.peoplename}" style="width:200px;" /><font color="red">*</font></td>
								</tr>

								<tr>
									<td style="background-color:#e8edef;">巡查范围坐标（东）：</td>
									<td><input name="xcjhEntity.east" id="east" type="text" class="scinput" value="${xcjhEntity.east}" style="width:200px;height:20px;" /><font color="red">*</font></td>
									<td style="background-color:#e8edef;">巡查范围坐标（南）：</td>
									<td ><input name="xcjhEntity.south" id="south" type="text" class="scinput" value="${xcjhEntity.south}" style="width:200px;height:20px;"/><font color="red">*</font></td>
								</tr>
								<tr>
									<td style="background-color:#e8edef;">巡查范围坐标（西）：</td>
									<td><input name="xcjhEntity.west" id="west" type="text" class="scinput" value="${xcjhEntity.west}" style="width:200px;height:20px;" /><font color="red">*</font></td>
									<td style="background-color:#e8edef;">巡查范围坐标（北）：</td>
									<td ><input name="xcjhEntity.north" id="north" type="text" class="scinput" value="${xcjhEntity.north}" style="width:200px;height:20px;"/><font color="red">*</font></td>
								</tr>
								...
								<tr>
									...
									<td colspan="3">
										<textarea rows="4" cols="70" name="xcjhEntity.substance"
												  id="substance">${xcjhEntity.substance}</textarea><font color="red">*</font>
									</td>
								</tr>
								<tr>
									...
									<textarea rows="4" cols="70" name="xcjhEntity.locationdesrcription"
											  id="locationdesrcription">${xcjhEntity.locationdesrcription}</textarea><font color="red">*</font>
									</td>
								</tr>

								<tr>
									<td style="background-color:#e8edef;">制定人姓名：</td>
									<td><input name="xcjhEntity.drafepeoplename" id="drafepeoplename" type="text" class="scinput" value="${xcjhEntity.drafepeoplename}" style="width:200px;height:20px;" /><font color="red">*</font></td>
								...
								<input name="xcjhEntity.drafepeopleid" id="xcjhEntity.drafepeopleid" type="hidden" value="${xcjhEntity.drafepeopleid }" />
								...
								<tr>
									<td colspan="4" style="text-align:center;">
										<input type="button" class="scbtn1" name="btn"  onclick="updateXcjh()" value="修改">
