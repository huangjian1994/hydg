...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script>
      ...
      /*  function updateXcjh(){
            ...
            document.myForm.action="<%=basePath%>/seaIslandPatrol/seaIslandPatrol_updateReport.do";
            document.myForm.target="_self";
            document.myForm.submit();
        }*/
      //审核通过
      function tg(){
          document.myForm.action="<%=basePath%>/seaIslandPatrol/seaIslandPatrol_shTg.do";
          document.myForm.target="_self";
          document.myForm.submit();
      }
      //审核不通过
      function btg(){
          document.myForm.action="<%=basePath%>/seaIslandPatrol/seaIslandPatrol_shBtg.do";
          document.myForm.target="_self";
          document.myForm.submit();
      }
        //返回
        function goBack(){
            document.myForm.action="<%=basePath%>/seaIslandPatrol/seaIslandPatrol_fetchXcjhShBack.do";
            document.myForm.target="_self";
            document.myForm.submit();
        }
							...
							<table width="100%" align="center" style="text-align:left;" class="tableXQ" cellSpacing='12' cellPadding='12'>
								<tr>
									...
									<td><input name="xcjhEntity.patrolname" id="patrolname" type="text"
												   class="scinput" value="${xcjhEntity.patrolname}" readonly="readonly" style="width:200px;" /><font color="red">*</font></td>
									<td style="background-color:#e8edef;">填表单位：</td>
									<td><input name="xcjhEntity.fillingdw" id="fillingdw" type="text"
											   class="scinput" value="${xcjhEntity.fillingdw}" readonly="readonly" style="width:200px;" /><font color="red">*</font></td>

								</tr>
								<tr>
									<td style="background-color:#e8edef;">起始时间：</td>
									<td><input name="xcjhEntity.begintime" id="begintime" type="text" class="scinput" value="${xcjhEntity.begintime}"
											   onclick="WdatePicker()" readonly="readonly" readonly="readonly" style="width:200px;" /><font color="red">*</font></td>
									<td style="background-color:#e8edef;">结束时间：</td>
									<td><input name="xcjhEntity.endtime" id="endtime" type="text" class="scinput" value="${xcjhEntity.endtime}"
											   onclick="WdatePicker()" readonly="readonly" readonly="readonly" style="width:200px;" /><font color="red">*</font></td>
								</tr>
								<tr>
									<td style="background-color:#e8edef;">领队名称：</td>
									<td><input name="xcjhEntity.leadername" id="leadername" type="text"
											   class="scinput" value="${xcjhEntity.leadername}" readonly="readonly" style="width:200px;" /><font color="red">*</font></td>
									<td style="background-color:#e8edef;">巡查方式：</td>
									<td><input name="xcjhEntity.inspectionmode" id="inspectionmode" type="text"
											   class="scinput" value="${xcjhEntity.inspectionmode}" readonly="readonly" style="width:200px;" /><font color="red">*</font></td>
								</tr>

								<tr>
									<td style="background-color:#e8edef;">派出人员：</td>
									<td><input name="xcjhEntity.peoplename" id="peoplename"
											   type="text" class="scinput" value="${xcjhEntity.peoplename}" readonly="readonly" style="width:200px;" /><font color="red">*</font></td>
								</tr>

								<tr>
									<td style="background-color:#e8edef;">巡查范围坐标（东）：</td>
									<td><input name="xcjhEntity.east" id="east" type="text" class="scinput" value="${xcjhEntity.east}"
											   readonly="readonly" style="width:200px;height:20px;" /><font color="red">*</font></td>
									<td style="background-color:#e8edef;">巡查范围坐标（南）：</td>
									<td ><input name="xcjhEntity.south" id="south" type="text" class="scinput" value="${xcjhEntity.south}"
												readonly="readonly" style="width:200px;height:20px;"/><font color="red">*</font></td>
								</tr>
								<tr>
									<td style="background-color:#e8edef;">巡查范围坐标（西）：</td>
									<td><input name="xcjhEntity.west" id="west" type="text" class="scinput" value="${xcjhEntity.west}"
											   readonly="readonly" style="width:200px;height:20px;" /><font color="red">*</font></td>
									<td style="background-color:#e8edef;">巡查范围坐标（北）：</td>
									<td ><input name="xcjhEntity.north" id="north" type="text" class="scinput" value="${xcjhEntity.north}"
												readonly="readonly" style="width:200px;height:20px;"/><font color="red">*</font></td>
								</tr>
								...
								<tr>
									...
									<td colspan="3">
										<textarea rows="4" cols="70" name="xcjhEntity.substance"
												  readonly="readonly" id="substance">${xcjhEntity.substance}</textarea><font color="red">*</font>
									</td>
								</tr>
								<tr>
									...
									<textarea rows="4" cols="70" name="xcjhEntity.locationdesrcription"
											  readonly="readonly" id="locationdesrcription">${xcjhEntity.locationdesrcription}</textarea><font color="red">*</font>
									</td>
								</tr>

								<tr>
									<td style="background-color:#e8edef;">制定人姓名：</td>
									<td><input name="xcjhEntity.drafepeoplename" id="drafepeoplename" type="text"
											   class="scinput" value="${xcjhEntity.drafepeoplename}" readonly="readonly" style="width:200px;height:20px;" /><font color="red">*</font></td>
									<td style="background-color:#e8edef;">制定日期：</td>
									<td ><input name="xcjhEntity.drafetdate" id="drafetdate" type="text" class="scinput" value="${xcjhEntity.drafetdate}"
											readonly="readonly" onclick="WdatePicker()"  style="width:200px;" /><font color="red">*</font></td>
								</tr>

								<input name="xcjhEntity.id" id="xcjhEntity.id" type="hidden" value="${xcjhEntity.id }" />
								...
								<tr>
									<td colspan="4" style="text-align:center;">
										<input type="button" style="width: 90px;" class="scbtn1" name="btn"  onclick="tg()" value="审核通过">
										<input type="button"  style="width: 90px;" class="scbtn1" name="btn"  onclick="btg()" value="审核不通过">
