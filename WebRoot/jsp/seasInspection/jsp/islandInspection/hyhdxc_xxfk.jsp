	...
	<body>
		...
		<div class="formbody">
				...
				<table width="90%" align="center" style="text-align:center;">
					...
					<tr>
						...
						<td>
							<select name="ssbm" id="ssbm" style="width:180px;height:25px;">
								<option value="">-请选择-</option>
								<option value="已上报">已反馈</option>
								<option value="未上报">未反馈</option>
							</select>
						</td>
					</tr>
					<tr>
			...
			<div class="tools">
				<ul class="toolbar">
					<li>
						<a href="${contextPath}/jsp/seasInspection/jsp/islandInspection/xxfk_fkadd.jsp">
                            <span><img src="${contextPath}/images/seasInspection/t01.png" /></span>新增
                        </a>
					</li>					
					<li>
						<a href="#"><span><img src="${contextPath}/images/seasInspection/t02.png" /></span>批量反馈</a>
					</li>
				</ul>
			</div>
			<br/>
			<table class="tablelist">
				...
				<tbody>
					<tr>
						...
						<td>已反馈</td>
						<td>
							<a href="${contextPath}/jsp/seasInspection/jsp/islandInspection/xxfk_fk.jsp" class="tablelink">反馈</a>
							<a href="${contextPath}/jsp/seasInspection/jsp/islandInspection/xxfk_fkxq.jsp" class="tablelink">详情</a>
							<a href="${contextPath}/jsp/seasInspection/jsp/islandInspection/xxfk_fkxg.jsp" class="tablelink">修改</a>
