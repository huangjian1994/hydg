						...
						<div id="tab1" class="tabson">
							<table width="100%" align="center" style="text-align:left;" class="tableXQ" cellSpacing='12' cellPadding='12'>
								...
								<tr>
									...
									<td>
										<select name="ssbm" id="ssbm" style="width:180px;height:20px;">
											...
											<option value="检查" selected="selected">检查</option>
										</select>
									</td>
									...
									<td>
										<select name="ssbm" id="ssbm">
											...
											<option value="宝山区" selected="selected">宝山区</option>
								...
								<tr>
									...
									<td colspan="3"><input name="" type="text" class="scinput" value="任务已完成" style="width:180px;height:20px;"/></td>
								</tr>
								<tr>
