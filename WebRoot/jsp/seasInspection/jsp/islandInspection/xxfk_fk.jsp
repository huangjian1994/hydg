			...
			<div class="mainbox">
				<div class="leftinfo1">
					<div class="listtitle3">
						<img src="${contextPath}/images/seasInspection/i02.png" width="25" height="25" />巡查任务反馈
					</div>
					<br/>					
					<div align="center">
						<div class="leftinfo1">
						...
						<br/>
						<div class="leftinfo1">
							<div class="listtitle3"><img src="${contextPath}/images/seasInspection/ticon.png" width="25" height="25" />巡查任务反馈</div>
							<table width="100%" align="center" style="text-align:left;" class="tableXQ" cellSpacing='12' cellPadding='12'>
								<tr>
								...
								<tr>
									<td style="background-color:#e8edef;">反馈意见</td>
									<td><textarea cols="50" rows="5"></textarea></td>
								</tr>
								<tr>
									<td colspan="4" style="text-align:center;">
										<input type="button" class="scbtn1" name="btn" onclick="window.location.href='hyhdxc_xxfk.jsp'" value="提交">
