...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$(document).ready(function(){
		...
		getDictionary("行政区划","ssqx","");
		getDictionary("海岛巡查问题类别","wtlb","");
	...
	function saveReport(){
		...
		document.myForm.action="<%=basePath%>/patorlReport/patorlReport_addReport.do";
		document.myForm.target="_self";
		document.myForm.submit();
	}
	</script>
						...
						<div id="tab1" class="tabson">
							<table width="100%" align="center" style="text-align:left;" class="tableXQ">
								<tr>
									...
									<td><input name="hyxcHdxcFxwt.sbrxm" id="sbrxm" type="text" class="scinput" value="<s:property value="#session.user.name" />" style="width:180px;" />
									<font color="red">*</font>
									</td>
									<td style="background-color:#e8edef;">上报人员单位名称：</td>
									<td><input name="hyxcHdxcFxwt.sbrdwmc" id="sbrdwmc" type="text" class="scinput" value="" style="width:180px;" /><font color="red">*</font></td>
								</tr>
								<tr>									
									<td style="background-color:#e8edef;">上报人员联系电话：</td>
									<td><input name="hyxcHdxcFxwt.sbrlxdh" id="sbrlxdh" type="text" class="scinput" value="" style="width:180px;" /><font color="red">*</font></td>
									<td style="background-color:#e8edef;">上报人员移动电话：</td>
									<td><input name="hyxcHdxcFxwt.sbryddh" id="sbryddh" type="text" class="scinput" value="" style="width:180px;" /></td>
								</tr>
								<tr>
									<td style="background-color:#e8edef;">上报日期：</td>
									<td><input name="hyxcHdxcFxwt.sbsj" id="sbsj" type="text" class="scinput" value="" style="width:180px;" onclick="WdatePicker()" readonly="readonly" /><font color="red">*</font></td>
								...
								<tr>
									...
									<td colspan="3"><input name="hyxcHdxcFxwt.fsdd" id="fsdd" type="text" class="scinput" value="" style="width:500px;" /><font color="red">*</font></td>
								</tr>
								
								
								<tr>
									<td width="20%" style="background-color:#e8edef;">北纬：</td>
									<td width="30%"><input name="hyxcHdxcFxwt.bw" id="bw" type="text" class="scinput" value="" style="width:180px;" /><font color="red">*</font></td>
									<td width="20%" style="background-color:#e8edef;">东经：</td>
									<td width="30%"><input name="hyxcHdxcFxwt.dj" id="dj" type="text" class="scinput" value="" style="width:180px;" /><font color="red">*</font></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td colspan="3">
									<textarea rows="4" cols="70" name="hyxcHdxcFxwt.wtms" id="wtms"></textarea><font color="red">*</font>
									</td>
								</tr>
								<tr>
									<td style="background-color:#e8edef;">现场照片：</td>
									<td colspan="3">
										<input name="upload"  type="file" style="width:180px;" /><font color="red">*</font>
									</td>
								</tr>
								<tr>
									<td colspan="4" style="text-align:center;">
										<input type="button" class="scbtn1" name="btn" onclick="saveReport()" value="保存" />
