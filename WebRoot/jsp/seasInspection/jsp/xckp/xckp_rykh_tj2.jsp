...
function resert(){
	...
	document.getElementById("jidu").value ="";
...
function goDownloadData(){
	document.myForm.action="<%=basePath%>/patorl/patorl_downLoadRykh.do";
	document.myForm.target="_self";
	document.myForm.submit();
}
</script>
...
<form name="myForm" method="post" >
			...
			<div class="leftinfo1">
				<div class="itab" >
					<ul>
						...
						<li><a href="###" onclick="goTj2()" class="selected">季度报</a></li>
				...
				<table width="100%" align="center" style="text-align:center;">
					<tr>
						...
						<td width="10%">时间：</td>
						<td width="30%">
						<select name="searchForm.year" id="year" style="width:100px;">
							<option value="">-请选择-</option>
						...
						第
						<select name="searchForm.jidu" id="jidu" style="width:100px;">
							<!-- 
							<option value="">-请选择-</option>
							 -->
						...
						<input name="jiduY" id="jiduY" type="hidden" value="${searchForm.jidu }"  />
						</td>
					</tr>
					<tr>
						<td colspan="6">
		...
		<script type="text/javascript">
			...
			var yearD = document.getElementById("yearY").value;
			var jidu = document.getElementById("jiduY").value;
			...
			var jldw = "分";
			var titlemc="巡查人员考核评价统计-"+xzqh+yy+"第"+jidu+"季度报";
	...
	<div align="center" style="font-size:14px;"><s:property value="pageBean" escapeHtml="false"/></div>
		...
		if(document.getElementById("jiduY").value ==""){
			document.getElementById("jidu").value ="";
		}else{
			document.getElementById("jidu").value =document.getElementById("jiduY").value;
		}
