...
<link href="../css/icon.css" rel="stylesheet" type="text/css" />-->
		...
		<script type="text/javascript">
			...
			function godatil() {
				window.open("detail.jsp", "displayWindow", "menubar=yes,width=600,height=450");
			}
		</script>
				...
				<div id="tab1" class="tabson">
					<div class="leftinfo1">
						...
						<table width="80%" align="center" style="text-align:center;" class="tableXQ" cellSpacing='12' cellPadding='12'>
							<tr>
								<td style="background-color:#e8edef;">目标雷达：</td>
							...
							<tr>
								<td style="background-color:#e8edef;">目标编号：</td>
								<td><input name="" type="text" class="scinput" value="" style="width:280px;height:20px;" />
								</td>
							</tr>
							<tr>
								<td style="background-color:#e8edef;">距离：</td>
								<td><input name="" type="text" class="scinput" value="" style="width:280px;height:20px;" />
								</td>
							</tr>
							<tr>
								<td style="background-color:#e8edef;">经纬度：</td>
								<td><input name="" type="text" class="scinput" value="" style="width:280px;height:20px;" />
								</td>
							</tr>
							<tr>
								<td style="background-color:#e8edef;">航速：</td>
								<td><input name="" type="text" class="scinput" value="" style="width:280px;height:20px;" />
								</td>
							</tr>
							<tr>
