...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script type="text/javascript">
            ...
            //导出
            function goDownloadMonthData(){
                document.myForm.action="<%=basePath%>/pip/pip_downLoadMonthData.do";
                document.myForm.target="_self";
                document.myForm.submit();
            }
		</script>
			...
			<div id="usual1" class="usual">
				<div class="itab">
					<ul>
						...
						<li><a href="###"  class="selected" >月报</a></li>
					...
					<div class="leftinfo1">
						...
						<table width="100%" align="center" style="text-align:center;">
							<tr >
								...
								<td width="20%">选择查询月份：</td>
								<td align="left">
									<input name="beginTimeM" id="beginTimeM" value="${beginTimeM}"
										   onclick="WdatePicker({dateFmt:'yyyy-MM'})" readonly="readonly" style="width:150px; overflow:auto;" />

									至
									<input name="endTimeM" id="endTimeM" value="${endTimeM}"
										   onclick="WdatePicker({dateFmt:'yyyy-MM'})" readonly="readonly" style="width:150px; overflow:auto;" />
							...
							<tr>
								<td colspan="6">
									...
									<input name="" type="reset" onclick="goDownloadMonthData()" class="scbtn1" value="导出" />&nbsp;&nbsp;&nbsp;&nbsp;
								</td>
							</tr>
