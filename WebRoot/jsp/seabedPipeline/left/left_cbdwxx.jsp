 ...
 <%--   <script language="JavaScript" src="${contextPath}/js/jquery.js"></script>--%>
	...
	<script type="text/javascript">
		...
		$(function(){	
		    ...
		    //addTab("船舶实时位置信息", "${contextPath}/ais/ais_oneRealtime.do");
...
<body style="background:#f0f9fd;">
	<div style="height: 100%;width: 187px">
    	...
    	<dl class="leftmenu">
			<s:iterator  value="#session.menusMap.get('cbdwxx')" status="stu">
				<dd>
					<div class="title">
			...
			<dd>
			    <div class="title">
			        ...
			        <%--<a href="${contextPath}/jsp/seabedPipeline/jsp/shipPositioningInformation/cbdwxx_index.jsp" target="rightFrame">--%>
			        <a class="easyui-linkbutton" href="#" onclick="addTab('船舶实时位置信息','${contextPath}/ais/ais_oneRealtime.do')">船舶实时位置信息</a>
			    </div>		    
		    </dd>
		    <dd>
		        <div class="title">
		            <span class="tle"><img src="${contextPath}/images/seasProfession/leftico01.png"/></span>
		            <a class="easyui-linkbutton" href="#" onclick="addTab('船舶档案信息','${contextPath}/ais/ais_boatRecord.do')">船舶档案信息</a>
		        </div>
		    </dd>
		      -->
    	</dl>
