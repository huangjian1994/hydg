 ...
 */
public interface SeaIslandPatrolDao {
    /**
     *Description :查询巡查计划
     ...
     */
    List<ThyxcHdxcXcjhEntity> fetchChxcList(ThyxcHdxcXcjhEntity xcjhEntity, PageBean pageBean, String userName, String userRoleName);
