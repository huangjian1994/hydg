...
public class BaseDAOImpl<T, ID extends Serializable> implements IBaseDAO<T, ID> {
	...
	public Object findUniqueResultByHql(String hql, Map<String, Object> args){
	...
	public Object findUniqueResultBySql(String sql, Map<String, Object> args){
