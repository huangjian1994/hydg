...
public class PageBeanS {
	...
	public PageBeanS(HttpServletRequest request) {
		super();
	...
	public String toString() {
		...
		bf.append("</form>");
		bf.append("<br /><table class='tttt' align='center' style='border:none;width:auto;table-layout : auto;'>");
		// 显示分页按钮
		bf.append("<tr><td  style='border:0px ' >");
		bf.append("<a  plain='true'  class='easyui-linkbutton' >");
//		bf.append("<strong>每页 " + this.getPageRecord() + " 行");
		bf.append(" <strong>共 " + this.getTotalRecord() + " 行");
		bf.append(" 第 " + this.getCurPage() + " 页");
		bf.append(" 共 " + this.getMaxPageNumber() + " 页");
		bf.append("</strong></a></td>");
		bf.append(" <td style='border:none'  ><a style='border:0px solid #9DC9E1;' plain='true' class='easyui-linkbutton' href='javascript:gotoPage(" + 1 + ")'><strong>首页</strong></a>");
		bf.append(" <a style='border:0px solid #9DC9E1;' plain='true' class='easyui-linkbutton' href='javascript:gotoPage("
				+ this.getPreviousPageNumber() + ")'><strong>上一页</strong></a>");
		bf.append(" <a style='border:0px solid #9DC9E1;' plain='true' class='easyui-linkbutton' href='javascript:gotoPage(" + this.getNextPageNumber()
				+ ")'><strong>下一页</strong></a>");
		bf.append(" <a style='border:0px solid #9DC9E1;' plain='true' class='easyui-linkbutton'  href='javascript:gotoPage(" + this.getMaxPageNumber()
